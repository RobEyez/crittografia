            ...
            <form method="POST">
                ...
                ?>
                    ...
                    <div class="testoDaCifrare">
                        ...
                        <textarea type="textarea" name="critta" placeholder="inserire testo da cifrare qui"><?php if(isset($_POST["critta"])){echo $plaintext;}else{}?></textarea><br>
                    ...
                    <div class="testoCifrato">
                        ...
                        <textarea type="text" name="useless" placeholder="visualizzazione testo cifrato" style="color:white;font-size: 18px;" id="myInput"><?php 
